...
class AIBlogPostController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.blog.ai-posts.create', compact('categories', 'tags'));
    }
    ...
    public function generate(Request $request)
    {
        ...
        try {
            ...
            if (strpos($errorMessage, 'timeout') !== false || strpos($errorMessage, 'Timeout') !== false) {
                ...
                $userMessage = 'مشكلة في API Key. يرجى التحقق من إعدادات الذكاء الاصطناعي في .env';
    ...
    public function store(Request $request)
    {
        ...
        $request->merge(array_diff_key($request->all(), array_flip([
            'topic', 'content_length', 'tone', 'language',

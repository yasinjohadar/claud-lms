         ...
         <header class="app-header">
            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-right">
                    ...
                    <!-- نقاط وجواهر -->
                    @auth
                    @php $headerStats = auth()->user()->stats()->firstOrCreate(['user_id' => auth()->id()]); @endphp
                    <div class="header-element d-none d-md-block">
                        <a href="{{ route('gamification.points.index') }}" class="header-link d-flex align-items-center gap-1 text-decoration-none" title="نقاطي">
                            <i class="ri-vip-diamond-line text-warning fs-18"></i>
                            <span class="fs-12 fw-semibold" id="headerGamificationPoints">{{ number_format($headerStats->available_points ?? 0) }}</span>
                        </a>
                    </div>
                    @endauth
                    ...
                    <div class="header-element notifications-dropdown main-header-notification">
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message" data-popper-placement="none">
                            <div class="menu-header-content bg-primary text-fixed-white">
                                ...
                                <p class="dropdown-title-text subtext mb-0 text-fixed-white op-6 pb-0 fs-12" id="headerNotificationCount">جاري التحميل...</p>
                            </div>
                            <div><hr class="dropdown-divider"></div>
                            <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                <li class="dropdown-item text-center py-3" id="headerNotificationEmpty">
                                    <p class="text-muted mb-0">لا توجد إشعارات</p>
                                </li>
                            </ul>
                            <div class="text-center dropdown-footer">
                                <a href="{{ route('gamification.notifications.index') }}" class="text-primary fs-13">عرض الكل</a>
                            </div>
                        </div>
                        <!-- End::main-header-dropdown -->
                    </div>
                    ...
                    <div class="header-element headerProfile-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            ...
                            @else
                                <svg width="37" height="37" viewBox="0 0 37 37" xmlns="http://www.w3.org/2000/svg" class="rounded-circle">
                                    ...
                                    <text x="18.5" y="24" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="white" text-anchor="middle">{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}</text>
                                </svg>
                            @endif
                        </a>
                        <!-- End::header-link|dropdown-toggle -->
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                            ...
                            <li>
                                <a class="dropdown-item d-flex border-block-end" href="{{ route('profile.edit') }}">

...
<div class="main-content app-content student-qm-stats-page">
    <div class="container-fluid pb-3">
        ...
        @include('student.pages.question-modules.partials.stats-kpi', compact(
        ...
        <div class="row align-items-start g-3 student-qm-stats-content-row">
            <div class="col-xl-8 col-lg-7 d-flex flex-column gap-3">
                ...
                @include('student.pages.question-modules.partials.stats-recent-attempts', ['recentAttempts' => $recentAttempts])
            </div>

            <div class="col-xl-4 col-lg-5 d-flex flex-column gap-3">
                @include('student.pages.question-modules.partials.stats-sidebar', compact(
                    'bestAttempt',
                    'uniqueModules',
                    'failedAttempts',
                    'passedAttempts',

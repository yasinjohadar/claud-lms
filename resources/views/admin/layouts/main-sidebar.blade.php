            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub {{ request()->routeIs('admin.courses.*') ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item {{ request()->routeIs('admin.courses.*') ? 'active' : '' }}">
                                <span class="side-menu__icon side-menu__icon--boxed side-menu__icon--blog">
                                    <i class="ri-graduation-cap-line"></i>
                                </span>
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide {{ request()->routeIs('admin.courses.categories.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.courses.categories.index') }}" class="side-menu__item">التصنيفات</a>
                                </li>
                                <li class="slide {{ request()->routeIs('admin.courses.tags.*') ? 'active' : '' }}">

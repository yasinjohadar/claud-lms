...
return [
    'groups' => [
        ...
        'question_bank' => [
            'label' => 'بنك الأسئلة',
            'permissions' => [
                'question-bank-list' => 'عرض بنك الأسئلة',
                'question-bank-create' => 'إنشاء سؤال',
                'question-bank-edit' => 'تعديل سؤال',
                'question-bank-delete' => 'حذف سؤال',
                'question-bank-import' => 'استيراد أسئلة',
                'question-bank-export' => 'تصدير أسئلة',
                'question-bank-duplicate' => 'نسخ سؤال',
                'question-bank-bulk-action' => 'إجراءات جماعية على الأسئلة',
            ],
        ],
        'quizzes' => [
            'label' => 'الاختبارات',
            'permissions' => [
                'quiz-list' => 'عرض الاختبارات',
                'quiz-create' => 'إنشاء اختبار',
                'quiz-edit' => 'تعديل اختبار',
                'quiz-delete' => 'حذف اختبار',
                'quiz-manage-questions' => 'إدارة أسئلة الاختبار',
                'quiz-toggle-publish' => 'نشر/إلغاء نشر اختبار',
            ],
        ],
        'grading' => [
            'label' => 'تصحيح الاختبارات',
            'permissions' => [
                'grading-list' => 'عرض قائمة التصحيح',
                'grading-grade' => 'تصحيح إجابة',
                'grading-bulk-grade' => 'تصحيح جماعي',
                'grading-complete' => 'إكمال التصحيح',
                'grading-regrade' => 'إعادة تصحيح محاولة',
                'grading-export-report' => 'تصدير تقرير التصحيح',
            ],
        ],
        'quiz_analytics' => [
            'label' => 'تحليلات الاختبارات',
            'permissions' => [
                'quiz-analytics-list' => 'عرض تحليلات الاختبارات',
                'quiz-analytics-view' => 'عرض تحليل اختبار',
                'quiz-analytics-export' => 'تصدير تحليلات',
                'quiz-analytics-compare' => 'مقارنة النتائج',
            ],
        ],
        'question_pools' => [
            'label' => 'مجموعات الأسئلة',
            'permissions' => [
                'question-pool-list' => 'عرض مجموعات الأسئلة',
                'question-pool-create' => 'إنشاء مجموعة',
                'question-pool-edit' => 'تعديل مجموعة',
                'question-pool-delete' => 'حذف مجموعة',
                'question-pool-manage' => 'إدارة أسئلة المجموعة',
            ],
        ],
        'question_modules' => [
            'label' => 'وحدات الأسئلة',
            'permissions' => [
                'question-module-list' => 'عرض وحدات الأسئلة',
                'question-module-create' => 'إنشاء وحدة',
                'question-module-edit' => 'تعديل وحدة',
                'question-module-delete' => 'حذف وحدة',
                'question-module-manage' => 'إدارة أسئلة الوحدة',
                'question-module-grading' => 'تصحيح وحدات الأسئلة',
            ],
        ],
        'gamification' => [
            'label' => 'التحفيز والمكافآت',
            'permissions' => [
                'gamification-dashboard' => 'لوحة تحكم التحفيز',
                'gamification-points' => 'إدارة النقاط',
                'gamification-levels' => 'إدارة المستويات',
                'gamification-badges' => 'إدارة الشارات',
                'gamification-achievements' => 'إدارة الإنجازات',
                'gamification-challenges' => 'إدارة التحديات',
                'gamification-leaderboards' => 'إدارة لوائح المتصدرين',
                'gamification-shop' => 'إدارة المتجر',
                'gamification-purchases' => 'عرض المشتريات',
                'gamification-social' => 'إدارة الأنشطة الاجتماعية',
                'gamification-competitions' => 'إدارة المسابقات',
                'gamification-analytics' => 'تحليلات التحفيز',
                'gamification-recalculate' => 'إعادة حساب بيانات التحفيز',
            ],
        ],
        'legacy' => [
